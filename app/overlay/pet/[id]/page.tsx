...
export default function PetOverlay() {
  ...
  function getRiggyImage() {
    ...
    if (event.mood === "happy") return "/pets/riggy_happy.png";
    if (event.mood === "sad") return "/pets/riggy_sad.png";
    if (event.mood === "sleep") return "/pets/riggy_sleep.png";
    if (blinking) return "/pets/riggy_blink.png";
    ...
    >
      <div className="absolute bottom-10 left-10 flex items-end gap-4">
        <img
          src={getRiggyImage()}
          alt="Riggy"
          className="h-32 w-32 object-contain drop-shadow-[0_0_25px_rgba(255,0,200,0.9)] animate-[riggyIdle_2s_ease-in-out_infinite]"
        />
